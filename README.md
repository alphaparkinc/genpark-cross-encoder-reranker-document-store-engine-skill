# genpark-cross-encoder-reranker-document-store-engine-skill
...
> **GenPark AI Agent Skill** -- Cross-encoder reranker document store engine for high precision RAG (Haystack style)
